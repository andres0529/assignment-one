<footer>
    <ul class="d-flex justify-content-center align-items-center h-100">
        <li>
            <a href="http://www.myportfolio.com.co">
                <img src="<?php echo esc_url(home_url('wp-content/themes/assignmentOne/assets/images/portfolio.png')); ?>" alt="header logo">
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="https://www.instagram.com/andres0529/">
